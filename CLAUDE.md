...
- Packages planned (updated 2026-05-13 after gossip-rejection brainstorm; phase 2a complete 2026-05-14):
  - `@ergots/nipopow` — NiPoPoW proof parser + verifier + P2P envelope codec. ✅ v1 complete; local v0.2.0 (247 tests). Published pre-rename as `@mwaddip/ergots-proof@0.1.0`; the `@ergots/nipopow` name is not yet on npm.
