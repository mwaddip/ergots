...
New `SValueParseError` codes (forthcoming — land in the T3 codec task): `'unsigned-bigint-too-large'` (`> 32` byte payload; mirrors `CoreDataSerializer.scala:120`).
